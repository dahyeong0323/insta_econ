...
export const middleSchoolEconomicsTopics: ResearchTopic[] = [
  ...
  withSeries("money-and-finance", {
    id: "stock-basic",
    conceptId: "stock-basic",
    title: "주식이 뭐야? 회사를 잘게 나눈 조각이라고 보면 돼",
    summary: "주식을 회사 조각, 소유권, 기대와 위험이라는 관점에서 쉽게 푼다.",
    keyTerms: ["주식", "회사", "소유권", "투자"],
    aliases: ["회사 조각", "주주", "투자", "지분"],
    sourceTextSeed:
      "주식은 회사를 아주 잘게 나눈 조각 가운데 일부를 갖는 것이다. 그래서 주식을 산다는 것은 단순히 숫자를 사고파는 것이 아니라 그 회사의 일부를 가진다는 뜻에 가깝다. 다만 회사가 잘되면 가치가 오를 수 있지만, 반대로 손해를 볼 수도 있어 기대와 위험이 함께 움직인다. 학생에게는 '좋아하는 가게를 친구들과 조금씩 같이 가진다면?' 같은 비유가 이해를 돕는다.",
    seriesOrder: 2,
    curriculumPosition: "금융 2단계: 주식이 무엇을 사고파는 것인지 감각적으로 이해하기",
    teachingAngle: "주식을 복잡한 차트가 아니라 회사 조각을 나눠 가진다는 감각으로 설명한다.",
    prerequisiteTopicIds: ["money-functions"],
    followUpTopicIds: ["inflation-purchasing-power"],
  }),
  withSeries("money-and-finance", {
    ...
    seriesOrder: 3,
    curriculumPosition: "금융 3단계: 돈의 가치가 변할 수 있다는 점 이해하기",
  ...
  withSeries("money-and-finance", {
    ...
    seriesOrder: 4,
    curriculumPosition: "금융 4단계: 돈을 미루어 쓰는 선택과 보상을 이해하기",
  ...
  withSeries("money-and-finance", {
    ...
    seriesOrder: 5,
    curriculumPosition: "금융 5단계: 미래 소득을 당겨 쓰는 선택의 비용 이해하기",
  ...
  withSeries("money-and-finance", {
    ...
    seriesOrder: 6,
    curriculumPosition: "금융 6단계: 국내 생활과 세계 경제가 이어져 있음을 이해하기",
  ...
  withSeries("money-and-finance", {
    ...
    seriesOrder: 7,
    curriculumPosition: "금융 7단계: 불확실한 미래 비용을 관리하는 방법 이해하기",
